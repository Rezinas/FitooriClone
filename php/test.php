...
$elements8 = array (
  "custom_product" => [ array(
      "id" => 90,
      "carouselImg" => "DSC_1135_goldstud_1479383423.png",
      "imgheight" => 23,
      "imgwidth" => 15,
      "bodypart" => 3,
      "centerx" => 22,
      ...
      "selectedImage" => "DSC_1135_goldstud_1479383423.png",
      "topPos" => 7,
      "leftPos" => 22
    ), array(
      "id" => 92,
      "carouselImg" => "DSC_0954-_1479384233.png",
      "imgheight" => 17,
      "imgwidth" => 13,
      "bodypart" => 3,
      "centerx" => 0,
      ...
      "color" => "Silver,Brown",
      "texture" => "Plain",
      "style" => "dangler,jhumka,chandelier,hoop",
      "admintags" => "",
      "material" => 3,
      "price" => 2,
      "name" => "Metal beads",
      ...
      "selectedImage" => "DSC_0954-_1479384233.png",
      "topPos" => 29,
      "leftPos" => 23
    ), array(
      "id" => 59,
      "carouselImg" => "DSC_1130_1479135824.png",
      "imgheight" => 45,
      "imgwidth" => 73,
      "bodypart" => 3,
      "centerx" => 0,
      ...
      "selectedImage" => "DSC_1130_1479135824.png",
      "topPos" => 46,
      "leftPos" => -7
    )
  ],
...
$elements7 = array (
  "custom_product" => [ array (
      "id" => 22,
      "carouselImg" => "Creme_stud_1478791459.png",
      "imgheight" => 21,
      "imgwidth" => 20,
      "bodypart" => 3,
      "centerx" => 20,
      ...
      "botX" => "6",
      "botY" => "26",
      "color" => "Red,Blue,Orange,Yellow,Silver,Pink,Black,Brown,White,Green,Purple,Indigo,Aqua,Beige",
      "texture" => "Plain",
      "style" => "dangler,jhumka,chandelier,stud",
      "admintags" => "",
      "material" => 2,
      "price" => 6,
      "name" => "Glass Stud",
      ...
      "selectedImage" => "Creme_stud_1478791459.png",
      "topPos" => 0,
      "leftPos" => 20
    ),
    array (
      "id" => 6,
      "carouselImg" => "unnamed (14)_1478848403.png",
      "imgheight" => 55,
      "imgwidth" => 32,
      "bodypart" => 3,
      "centerx" => 0,
      ...
      "botX" => "11",
      "botY" => "53",
      "color" => "Red,Orange,Pink,Green,Purple,Multicolor",
      "texture" => "Plain",
      "style" => "dangler,jhumka,chandelier",
      "admintags" => "",
      "material" => 2,
      "price" => 5,
      "name" => "Semi-precious(Jade) Bead",
      "priority" => 1,
      "hookImg" => "",
      "availability" => null,
      "images" => [
      ...
      "selectedImage" => "DSC_1075_1478848403.png",
      "topPos" => 26,
      "leftPos" => 15
    )
  ],
...
function createCustomPrdImage($elemArr)
    ...
    $offsety = 30;
     foreach($elemArr as $key => $elm) {
      ...
      $imgpart = imagecreatefrompng("../productImages/".$elm['selectedImage']);
        ...
        echo "leftpos = ". $elm['leftPos'];
        echo "topPos = ". $elm['topPos'];
        echo "<br>";
 ...
 if(!imagepng($out, "../productImages/test/test2.png", 1)){
      return "ERROR";
    }
...
<img style="border: 1px solid;" src="../productImages/test/test0.png" />
<img style="border: 1px solid;" src="../productImages/test/test1.png" />
