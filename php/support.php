...
if(isset($_POST['support']))
  {
      ...
      $messageDetail = "Message was sent by ".$_POST['email']. "<br/> Their contact information is - ".$_POST['phone']. "<br/> Query is regarding - ".$_POST['queryBox']."<br/>The message sent is - ". $_POST['messageArea'];
